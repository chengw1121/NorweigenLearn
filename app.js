...
function bindView() {
  ...
  document.querySelector("#vocab-current")?.addEventListener("keydown", e => { if (e.key === "Enter") { e.preventDefault(); advanceVocabStep(); } });

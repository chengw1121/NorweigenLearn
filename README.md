...
主导航分为“今天、词汇记忆、专题、错题练习”。新增 `Tema: fremtid` 自学课程：8节语法、82个带情境插画符号和挪威语例句的跨词类词卡、原课本对话与阅读双语逐段朗读、16道自动判分题及8项写作迁移。开放式写作使用自检清单，不冒充AI评分。错题页可主动回忆作答，答对后移出待复习队列。
...
- `Fremtid · 未来` 专题将五种未来表达、V2语序、时态回顾、词汇、课本对话与阅读整合成完整学习闭环；词汇可按名词、动词、形容词、副词、介词和短语筛选，并用主动回忆后揭示答案的方式练习。
